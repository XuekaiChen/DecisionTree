...
def createDataSet():
    ...
    for cells in f.readlines():
        ...
        if int(cells[1]) < 29:
            cells[1] = '青年'
        elif (int(cells[1]) > 29) and (int(cells[1]) < 43):
            cells[1] = '中年'
        else:
            cells[1] = '老年'
        if float(cells[2]) < 6:
        ...
        if cells[4] == '1':
            ...
            cells[4] = '二者'
        if int(cells[5]) < 304: #100
            cells[5] = '小'
        elif (int(cells[5]) > 304) and (int(cells[5]) < 602): #600
            cells[5] = '中'
        else:
            cells[5] = '大'
        if int(cells[6]) < 10:
